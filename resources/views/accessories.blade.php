        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('storage/'.$accessory->gambar) }}" class="card-img-top" alt="{{ $accessory->nama }}">
                    <div class="card-body">
                        <h5 class="card-title">{{ $accessory->nama_produk }}</h5>
                        <p class="card-text">{{ $accessory->deskripsi }}</p>
                        <p class="card-text"><strong>Price: Rp.{{ number_format($accessory->harga, 0, ',', '.') }}</strong></p>
                    </div>
