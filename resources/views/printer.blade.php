...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-left mb-4">Printer</h1>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('storage/'.$printer->gambar) }}" class="card-img-top" alt="{{ $printer->nama }}">
                    <div class="card-body">
                        <h5 class="card-title">{{ $printer->nama_produk }}</h5>
                        <p class="card-text">{{ $printer->deskripsi }}</p>
                        <p class="card-text"><strong>Price: Rp.{{ number_format($printer->harga, 0, ',', '.') }}</strong></p>
                    </div>
